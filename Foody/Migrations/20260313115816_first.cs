        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Last4Digits = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    CardBrand = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    ExpiryMonth = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomizationOptions = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DisplayOrder = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CategoryId = table.Column<int>(type: "int", nullable: false),
                    OverrideDiscountValue = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DealCategories_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MenuItemId = table.Column<int>(type: "int", nullable: false),
                    OverrideDiscountValue = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    IsFreeItem = table.Column<bool>(type: "bit", nullable: false),
                    ComboSequence = table.Column<int>(type: "int", nullable: false),
                    AddedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DealMenuItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DealMenuItems_Deals_DealId",
                        column: x => x.DealId,
                        principalTable: "Deals",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DealMenuItems_MenuItems_MenuItemId",
                        column: x => x.MenuItemId,
                        principalTable: "MenuItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DealUsages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DealUsages_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DealUsages_Deals_DealId",
                        column: x => x.DealId,
                        principalTable: "Deals",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DealUsages_Orders_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DealCategories_CategoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DealMenuItems_DealId",
                table: "DealMenuItems",
                column: "DealId");

            migrationBuilder.CreateIndex(
                name: "IX_DealMenuItems_MenuItemId",
                table: "DealMenuItems",
                column: "MenuItemId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Deals_StartDate_EndDate",
                table: "Deals",
                columns: new[] { "StartDate", "EndDate" });

            migrationBuilder.CreateIndex(
                name: "IX_DealUsages_DealId_UserId",
                table: "DealUsages",
                columns: new[] { "DealId", "UserId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_DealUsages_OrderId",
                table: "DealUsages",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_DealUsages_UserId",
                table: "DealUsages",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MenuItemTags_MenuItemId",
                table: "MenuItemTags",
                column: "MenuItemId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Restaurants_City_IsOpen",
                table: "Restaurants",
